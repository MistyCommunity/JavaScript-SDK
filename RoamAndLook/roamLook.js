...
misty.MoveArmDegrees("left", 90, 45);
misty.Pause(50);
...
function _FaceRec(data){
    ...
    if (faceDetected == "unknown person"){
        ...
        misty.MoveArmDegrees("left", 0, 45);
        misty.Pause(50);
        misty.MoveArmDegrees("right", 0, 45);
        ...
        misty.MoveArmDegrees("left", -29, 45);
        misty.Pause(50);
        misty.MoveArmDegrees("right", -29, 45);
    } else {
